...
const CourseDetails = ({ route, navigation }) => {
    ...
    const courseTopics = [
        { id: '01', title: 'Introduction', courseId: 1 },
        { id: '02', title: 'Variables', courseId: 2 },
        { id: '03', title: 'Data Types', courseId: 3 },
        { id: '04', title: 'Numbers', courseId: 4 },
        { id: '05', title: 'Casting', courseId: 5 },
    ];
    ...
    <View style={courseStyles.container}>
        ...
        {courseTopics.map((topic) => (
            <TouchableOpacity
                ...
                onPress={() => navigation.navigate('CourseChapter', { courseId: topic.courseId })}
            >
                <Text style={courseStyles.topicNumber}>{topic.id}</Text>
                <Text style={courseStyles.topicTitle}>{topic.title}</Text>
